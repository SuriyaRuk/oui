...
function translateTimeRelativeToWeek(source, sourceReference, targetReference) {
  ...
  const dayOfWeekDelta = sourceReferenceDate.getDay() - targetReferenceDate.getDay(); // If we pretend that the targetReference is actually the same day of the week as the
