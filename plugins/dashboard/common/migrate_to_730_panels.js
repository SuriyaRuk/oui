...
function is640To720Panel(panel) {
  return _semver.default.satisfies(_semver.default.coerce(panel.version).version, '>6.3') && _semver.default.satisfies(_semver.default.coerce(panel.version).version, '<7.3');
...
function migrate640To720PanelsToLatest(panel, version) {
  var _panel$embeddableConf;

  const panelIndex = panel.panelIndex ? panel.panelIndex.toString() : _uuid.default.v4();
  const embeddableConfig = (_panel$embeddableConf = panel.embeddableConfig) !== null && _panel$embeddableConf !== void 0 ? _panel$embeddableConf : {};
  return { ...panel,
    version,
    panelIndex,
    embeddableConfig
