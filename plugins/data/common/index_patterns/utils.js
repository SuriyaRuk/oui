...
exports.validateDataSourceReference = exports.getIndexPatternTitle = void 0;
...
const getIndexPatternTitle = async (indexPatternTitle, references, getDataSource) => {
  ...
  let dataSourceTitle;
  const dataSourceReference = references.find(ref => ref.type === 'data-source'); // If an index-pattern references datasource, prepend data source name with index pattern name for display purpose
