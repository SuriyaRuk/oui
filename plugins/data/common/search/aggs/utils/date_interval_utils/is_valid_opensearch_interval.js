...
exports.isValidOpenSearchInterval = isValidOpenSearchInterval;
 ...
 */
function isValidOpenSearchInterval(interval) {
  try {
    (0, _parse_opensearch_interval.parseOpenSearchInterval)(interval);
    return true;
  } catch {
    return false;
  }
