...
Object.keys(_invalid_opensearch_calendar_interval_error).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _invalid_opensearch_calendar_interval_error[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _invalid_opensearch_calendar_interval_error[key];
    }
  });
});
...
Object.keys(_invalid_opensearch_interval_format_error).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _invalid_opensearch_interval_format_error[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _invalid_opensearch_interval_format_error[key];
    }
  });
});

var _is_valid_opensearch_interval = require("./is_valid_opensearch_interval");

Object.keys(_is_valid_opensearch_interval).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _is_valid_opensearch_interval[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _is_valid_opensearch_interval[key];
    }
  });
});
...
var _parse_opensearch_interval = require("./parse_opensearch_interval");

Object.keys(_parse_opensearch_interval).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _parse_opensearch_interval[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _parse_opensearch_interval[key];
    }
  });
});
