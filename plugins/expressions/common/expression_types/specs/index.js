...
var _opensearch_dashboards_datatable = require("./opensearch_dashboards_datatable");

Object.keys(_opensearch_dashboards_datatable).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _opensearch_dashboards_datatable[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _opensearch_dashboards_datatable[key];
    }
  });
});
 ...
 * under the License.
 */
const typeSpecs = [_boolean.boolean, _datatable.datatable, _error.error, _filter.filter, _image.image, _opensearch_dashboards_context.opensearchDashboardsContext, _opensearch_dashboards_datatable.opensearchDashboardsDatatable, _null.nullType, _num.num, _number.number, _pointseries.pointseries, _range.range, _render.render, _shape.shape, _string.string, _style.style];
