 ...
 * under the License.
 */
const functionSpecs = [_clog.clog, _font.font, _opensearch_dashboards.opensearchDashboards, _opensearch_dashboards_context.opensearchDashboardsContextFunction, _var_set.variableSet, _var.variable, _theme.theme];
