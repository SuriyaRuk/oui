...
var _timeline = _interopRequireDefault(require("../timeline.json"));
...
function _default() {
  ...
  const timelineDefaults = flattenWith('.', _timeline.default);
  return _lodash.default.reduce(timelineDefaults, (result, value, key) => {
    result['timeline:' + key] = value;
    return result;
  }, {});
}
