...
function chainRunner(tlConfig) {
  ...
  function invoke(fnName, args) {
    ...
    function resolveArgument(item) {
      ...
      if (_lodash.default.isObject(item)) {
        ...
        throw new Error(_i18n.i18n.translate('timeline.serverSideErrors.unknownArgumentTypeErrorMessage', {
  ...
  function processRequest(request) {
    ...
    tlConfig.time.interval = (0, _lib.calculateInterval)(tlConfig.time.from, tlConfig.time.to, tlConfig.settings['timeline:target_buckets'] || 200, tlConfig.time.interval, tlConfig.settings['timeline:min_interval'] || '1ms');
