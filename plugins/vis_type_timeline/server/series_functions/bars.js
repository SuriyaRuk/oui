...
var _default = new _chainable.default('bars', {
  args: [{
    ...
    name: 'width',
    types: ['number', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.bars.args.widthHelpText', {
      defaultMessage: 'Width of bars in pixels'
    })
  }, {
    name: 'stack',
    types: ['boolean', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.bars.args.stackHelpText', {
      defaultMessage: 'Should bars be stacked, true by default'
    })
  }],
  help: _i18n.i18n.translate('timeline.help.functions.barsHelpText', {
