...
var _default = new _datasource.default('worldbank_indicators', {
  args: [{
    ...
    types: ['string', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.worldbankIndicators.args.countryHelpText', {
      defaultMessage: `Worldbank country identifier. Usually the country's 2 letter code`
    })
  }, {
    name: 'indicator',
    types: ['string', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.worldbankIndicators.args.indicatorHelpText', {
  ...
  aliases: ['wbi'],
  help: _i18n.i18n.translate('timeline.help.functions.worldbankIndicatorsHelpText', {
    defaultMessage: `
    [experimental]
  ...
  fn: function worldbankIndicators(args, tlConfig) {
    ...
    const seriesLists = _lodash.default.map(countries, function (country) {
      ...
      return _worldbank.default.timelineFn(wbArgs, tlConfig);
    });
