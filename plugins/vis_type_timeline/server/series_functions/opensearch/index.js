...
var _default = new _datasource.default('es', {
  args: [{
    ...
    types: ['string', 'null'],
    multi: true,
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.qHelpText', {
    ...
    types: ['string', 'null'],
    multi: true,
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.metricHelpText', {
      defaultMessage: 'An opensearch metric agg: avg, sum, min, max, percentiles or cardinality, followed by a field. ' + 'E.g., "sum:bytes", "percentiles:bytes:95,99,99.9" or just "count"',
    ...
    types: ['string', 'null'],
    multi: true,
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.splitHelpText', {
      defaultMessage: 'An opensearch field to split the series on and a limit. E.g., "{hostnameSplitArg}" to get the top 10 hostnames',
      values: {
    ...
    name: 'index',
    types: ['string', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.indexHelpText', {
    ...
    name: 'timefield',
    types: ['string', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.timefieldHelpText', {
    ...
    name: 'kibana',
    types: ['boolean', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.opensearchDashboardsHelpText', {
      defaultMessage: 'Respect filters on OpenSearch Dashboards dashboards. Only has an effect when using on OpenSearch Dashboards dashboards'
    })
  }, {
    ...
    types: ['string', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.intervalHelpText', {
      defaultMessage: `**DO NOT USE THIS**. It's fun for debugging fit functions, but you really should use the interval picker`
    })
  }],
  help: _i18n.i18n.translate('timeline.help.functions.opensearchHelpText', {
  ...
  fn: async function opensearchFn(args, tlConfig) {
    ...
    const body = (0, _build_request.default)(config, tlConfig, scriptedFields, opensearchShardTimeout);
    const deps = (await tlConfig.getStartServices())[1];
    const resp = await deps.data.search.search(tlConfig.context, body, {
      strategy: _server.OPENSEARCH_SEARCH_STRATEGY
    });

    if (!resp.rawResponse._shards.total) {
      throw new Error(_i18n.i18n.translate('timeline.serverSideErrors.opensearchFunction.indexNotFoundErrorMessage', {
