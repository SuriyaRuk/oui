...
var _default = new _chainable.default('legend', {
  args: [{
    ...
    help: _i18n.i18n.translate('timeline.help.functions.legend.args.positionHelpText', {
    ...
    suggestions: [{
      name: 'false',
      help: _i18n.i18n.translate('timeline.help.functions.legend.args.position.suggestions.falseHelpText', {
        defaultMessage: 'disable legend'
      })
    }, {
      name: 'nw',
      help: _i18n.i18n.translate('timeline.help.functions.legend.args.position.suggestions.nwHelpText', {
        defaultMessage: 'place legend in north west corner'
      })
    }, {
      name: 'ne',
      help: _i18n.i18n.translate('timeline.help.functions.legend.args.position.suggestions.neHelpText', {
        defaultMessage: 'place legend in north east corner'
      })
    }, {
      name: 'se',
      help: _i18n.i18n.translate('timeline.help.functions.legend.args.position.suggestions.seHelpText', {
        defaultMessage: 'place legend in south east corner'
      })
    }, {
      name: 'sw',
      help: _i18n.i18n.translate('timeline.help.functions.legend.args.position.suggestions.swHelpText', {
    ...
    name: 'columns',
    types: ['number', 'null'],
    help: _i18n.i18n.translate('timeline.help.functions.legend.args.columnsHelpText', {
      defaultMessage: 'Number of columns to divide the legend into'
    })
  }, {
    name: 'showTime',
    types: ['boolean'],
    help: _i18n.i18n.translate('timeline.help.functions.legend.args.showTimeHelpText', {
      defaultMessage: 'Show time value in legend when hovering over graph. Default: true'
    })
  }, {
    name: 'timeFormat',
    types: ['string'],
    help: _i18n.i18n.translate('timeline.help.functions.legend.args.timeFormatHelpText', {
  ...
  help: _i18n.i18n.translate('timeline.help.functions.legendHelpText', {
