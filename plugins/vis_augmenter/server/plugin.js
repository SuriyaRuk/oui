...
class VisAugmenterPlugin {
  ...
  async setup(core) {
    ...
    const isAugmentationEnabled = config.pluginAugmentationEnabled === undefined ? true : config.pluginAugmentationEnabled; // Checks if the global yaml setting for enabling plugin augmentation is disabled.
