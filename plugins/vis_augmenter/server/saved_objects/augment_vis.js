 ...
 */
const augmentVisSavedObjectType = {
  name: 'augment-vis',
  hidden: false,
  ...
  management: {
    ...
    getTitle(obj) {
      ...
      return `augment-vis-${obj === null || obj === void 0 ? void 0 : (_obj$attributes = obj.attributes) === null || _obj$attributes === void 0 ? void 0 : _obj$attributes.originPlugin}`;
    },
...
exports.augmentVisSavedObjectType = augmentVisSavedObjectType;