 ...
 * under the License.
 */
async function getAnnotationRequestParams(req, panel, annotation, opensearchQueryConfig, capabilities) {
  ...
  const request = (0, _build_request_body.buildAnnotationRequest)(req, panel, annotation, opensearchQueryConfig, indexPatternObject, capabilities);
  return {
