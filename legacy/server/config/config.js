...
class Config {
  ...
  _commit(newVals) {
    ...
    const context = {
      ...
      buildNum: _utils.IS_OPENSEARCH_DASHBOARDS_DISTRIBUTABLE ? _utils2.pkg.build.number : Number.MAX_SAFE_INTEGER,
      buildSha: _utils.IS_OPENSEARCH_DASHBOARDS_DISTRIBUTABLE ? _utils2.pkg.build.sha : 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
      dist: _utils.IS_OPENSEARCH_DASHBOARDS_DISTRIBUTABLE
    };
