...
function downgradeIfErrorType(errorType, event) {
  ...
  const matchesErrorType = (0, _lodash.get)(event, 'error.code') === errorType || (0, _lodash.get)(event, 'error.errno') === errorType;
...
class LogInterceptor extends _stream.default.Transform {
  constructor() {
    super({
