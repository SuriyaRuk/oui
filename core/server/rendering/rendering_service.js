  ...
  async setup({
    ...
    return {
      render: async (request, uiSettings, {
        ...
        var _settings$user$theme, _settings$user, _settings$user$theme2, _settings$user$theme3, _settings$user2, _settings$user2$theme;
        ...
        const darkMode = ((_settings$user$theme = (_settings$user = settings.user) === null || _settings$user === void 0 ? void 0 : (_settings$user$theme2 = _settings$user['theme:darkMode']) === null || _settings$user$theme2 === void 0 ? void 0 : _settings$user$theme2.userValue) !== null && _settings$user$theme !== void 0 ? _settings$user$theme : uiSettings.getOverrideOrDefault('theme:darkMode')) || false; // At the very least, the schema should define a default theme; the '' will be unreachable

        const themeVersion = ((_settings$user$theme3 = (_settings$user2 = settings.user) === null || _settings$user2 === void 0 ? void 0 : (_settings$user2$theme = _settings$user2['theme:version']) === null || _settings$user2$theme === void 0 ? void 0 : _settings$user2$theme.userValue) !== null && _settings$user$theme3 !== void 0 ? _settings$user$theme3 : uiSettings.getOverrideOrDefault('theme:version')) || '';
