...
class ScopedClusterClient {
  constructor(asInternalUser, asCurrentUser, asInternalUserWithLongNumeralsSupport, asCurrentUserWithLongNumeralsSupport) {
    this.asInternalUser = asInternalUser;
    this.asCurrentUser = asCurrentUser;
    this.asInternalUserWithLongNumeralsSupport = asInternalUserWithLongNumeralsSupport;
    this.asCurrentUserWithLongNumeralsSupport = asCurrentUserWithLongNumeralsSupport;
  }
