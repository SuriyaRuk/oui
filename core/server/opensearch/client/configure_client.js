...
const configureClient = (config, {
  ...
  const client = withLongNumeralsSupport ? new _opensearchNext.Client({ ...clientOptions,
...
const addLogging = (client, logger, logQueries) => {
  client.on('response', (error, event) => {
    if (error) {
      var _event$body$error$typ, _event$body, _event$body$error, _event$body$error$rea, _event$body2, _event$body2$error;

      const errorMessage = // error details for response errors provided by opensearch, defaults to error name/message
      `[${(_event$body$error$typ = (_event$body = event.body) === null || _event$body === void 0 ? void 0 : (_event$body$error = _event$body.error) === null || _event$body$error === void 0 ? void 0 : _event$body$error.type) !== null && _event$body$error$typ !== void 0 ? _event$body$error$typ : error.name}]: ${(_event$body$error$rea = (_event$body2 = event.body) === null || _event$body2 === void 0 ? void 0 : (_event$body2$error = _event$body2.error) === null || _event$body2$error === void 0 ? void 0 : _event$body2$error.reason) !== null && _event$body$error$rea !== void 0 ? _event$body$error$rea : error.message}`;
