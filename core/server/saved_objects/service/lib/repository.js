...
class SavedObjectsRepository {
  ...
  async find(options) {
    ...
    return {
      ...
      saved_objects: body.hits.hits.map(hit => ({ // @ts-expect-error @opensearch-project/opensearch _source is optional
  ...
  async bulkGet(objects = [], options = {}) {
    ...
    return {
      saved_objects: expectedBulkGetResults.map(expectedResult => {
        ...
        const doc = bulkGetResponse === null || bulkGetResponse === void 0 ? void 0 : bulkGetResponse.body.docs[opensearchRequestIndex]; // @ts-expect-error MultiGetHit._source is optional
  ...
  async bulkUpdate(objects, options = {}) {
    ...
    return {
      saved_objects: expectedBulkUpdateResults.map(expectedResult => {
        ...
        const response = (_bulkUpdateResponse$b = bulkUpdateResponse === null || bulkUpdateResponse === void 0 ? void 0 : bulkUpdateResponse.body.items[opensearchRequestIndex]) !== null && _bulkUpdateResponse$b !== void 0 ? _bulkUpdateResponse$b : {}; // When a bulk update operation is completed, any fields specified in `_sourceIncludes` will be found in the "get" value of the
