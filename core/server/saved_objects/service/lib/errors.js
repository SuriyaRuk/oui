...
const CODE_TOO_MANY_REQUESTS = 'SavedObjectsClient/tooManyRequests'; // 400 - OpenSearch Cannot Execute Script

const CODE_OPENSEARCH_CANNOT_EXECUTE_SCRIPT = 'SavedObjectsClient/opensearchCannotExecuteScript'; // 503 - OpenSearch Unavailable

const CODE_OPENSEARCH_UNAVAILABLE = 'SavedObjectsClient/opensearchUnavailable'; // 500 - General Error
