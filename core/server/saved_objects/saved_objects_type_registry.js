...
class SavedObjectTypeRegistry {
  ...
  isImportableAndExportable(type) {
    var _this$types$get$manag, _this$types$get5, _this$types$get5$mana;

    return (_this$types$get$manag = (_this$types$get5 = this.types.get(type)) === null || _this$types$get5 === void 0 ? void 0 : (_this$types$get5$mana = _this$types$get5.management) === null || _this$types$get5$mana === void 0 ? void 0 : _this$types$get5$mana.importableAndExportable) !== null && _this$types$get$manag !== void 0 ? _this$types$get$manag : false;
  }
